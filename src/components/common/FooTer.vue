  ...
  <footer class="navbar navbar-dark bg-primary">
    <div class="container">
      ...
      <ul class="list-inline mb-0">
        <li class="list-inline-item"><router-link class="nav-link" to="/aviso-legal" target="_blank">Aviso
            legal</router-link></li>
        <li class="list-inline-item"><router-link class="nav-link" to="/politica-privacidad" target="_blank">Política de
